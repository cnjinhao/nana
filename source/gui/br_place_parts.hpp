 ...
 */
#ifndef NANA_GUI_BR_PLACE_PARTS_HPP
#define NANA_GUI_BR_PLACE_PARTS_HPP
...
namespace nana
{
	namespace br_place_parts
	{
		...
		private:
			...
			{
				this->caption("br_place-splitter");
		...
		public:
			void set_notifier(br_place_parts::dock_notifier_interface* notifier)
			{
				notifier_ = notifier;
			}
	...
	}//end namespace br_place_parts
}//end namespace nana

#endif //NANA_GUI_BR_PLACE_PARTS_HPP
