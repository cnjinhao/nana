...
*/
	...
	/// An interface to adjust screen coordinate
	class coordinate_adjuster
	{
	public:
		virtual ~coordinate_adjuster() = default;

		/// Adjust the screen coordinate
		/**
		 * @param pos The screen position generated by system. E.g mouse, touchscreen.
		 * @return the adjusted position
		 */
		virtual point adjust(point pos) = 0;
	};
}//end namespace nana
