...
namespace nana::paint::image_process
{
	...
	public:
		...
		virtual void process(const paint::pixel_buffer& s_pixbuf, const nana::rectangle& s_r, paint::pixel_buffer& d_pixbuf, const point& d_pos, alpha_methods) const = 0;
	};
